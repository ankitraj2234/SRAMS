...
CREATE TABLE IF NOT EXISTS srams.users (
...
-- Documents table
CREATE TABLE IF NOT EXISTS srams.documents (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    title TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS srams.document_access (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS srams.document_requests (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES srams.users(id) ON DELETE CASCADE,
    document_id UUID NOT NULL REFERENCES srams.documents(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS srams.document_views (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    document_id UUID NOT NULL REFERENCES srams.documents(id) ON DELETE CASCADE,
    user_id UUID NOT NULL REFERENCES srams.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS auth.desktop_sessions (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES srams.users(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS auth.device_certificates (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id UUID NOT NULL REFERENCES srams.users(id) ON DELETE CASCADE,
...
DROP TRIGGER IF EXISTS users_updated_at ON srams.users;
